...
task main()
{
	while(true)
	{
		...
		displayTextLine(1, "Strong:  %d mm", getDistanceStrongest(distanceMM));
		displayTextLine(2, "2ndStr:  %d mm", getDistanceSecondStrongest(distanceMM));
		displayTextLine(3, "Reflect: %d mm", getDistanceMostReflective(distanceMM));
