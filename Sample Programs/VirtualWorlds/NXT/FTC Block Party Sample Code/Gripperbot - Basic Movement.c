...
task main()
{
	...
	//Turn the robot to the right for 2130 encoder counts
	//at a speed of 25, then wait for half of a second
	turnRight(2130, 25);
	wait1Msec(500);

	//Turn the robot to the left for 2130 encoder counts
	//at a speed of 25, then wait for half of a second
	turnLeft(2130, 25);
	wait1Msec(500);
}
